...
if ($stmt->execute()) {
    ...
    $stmt = $conn->prepare('INSERT INTO notifications (user_id, title, message, type, link) VALUES (?, "Booking Cancelled", "Your booking has been cancelled by the landlord.", "warning", "/board-in/student/my-bookings.php")');
