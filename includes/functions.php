...
function flash_render()
{
    ...
    foreach ($_SESSION['flash'] as $key => $msg) {
        // allow key to define type e.g. error, success, info
        $type = 'info';
...
// Small convenience wrapper used in templates (keeps naming short)
function esc($value) {
    return esc_attr($value);
}

// Return a Source Unsplash URL for a query to use as a fallback image
