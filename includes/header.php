      ...
      <div class="collapse navbar-collapse" id="navMenu">
        <ul class="navbar-nav ms-auto">
          ...
          if (isset($_SESSION['user'])) {
            $ut = strtolower($_SESSION['user']['user_type'] 
              ?? $_SESSION['user']['role'] 
              ?? $_SESSION['user']['type'] 
              ?? '');

            if ($ut === 'student') {
              $home_link = '/board-in/user/dashboard.php';
            } elseif ($ut === 'landlord') {
              $home_link = '/board-in/landlord/dashboard.php';
            } elseif ($ut === 'admin') {
              $home_link = '/board-in/admin/dashboard.php';
            } else {
              $home_link = '/board-in/pages/index.php';
            }
          } else {
            $home_link = '/board-in/pages/index.php';
          }
          ...
          <?php if (isset($_SESSION['user'])): ?>
            ...
            <?php if ($ut === 'student'): ?>
              <li class="nav-item">
                <a class="nav-link" href="/board-in/user/dashboard.php">
            ...
            <?php if ($ut === 'landlord' || $ut === 'admin'): ?>
              <li class="nav-item">
                <a class="nav-link" href="/board-in/landlord/add-listing.php">
                  <i class="bi bi-plus-circle me-1"></i>Add Listing
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/board-in/landlord/my-listings.php">
                  <i class="bi bi-list-ul me-1"></i>My Listing
                </a>
              </li>
            <?php endif; ?>
