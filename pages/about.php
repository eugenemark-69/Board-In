        ...
        <div class="col-md-4 mb-4">
            <div class="team-card">
                ...
                <div class="card-body text-center pb-4">
                    ...
                    <p class="text-muted mb-3">POGI NA CEO</p>
                    <p class="small">Pinaka gwapo sa balat n lupa, Masyado nakong malakas para sa mundo ng mga tao. ayaw kol bata pako kol.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="team-card">
                <div class="team-avatar">J</div>
                <div class="card-body text-center pb-4">
                    <h4 class="fw-bold mb-1">JOEY THE GREAT</h4>
                    <p class="text-muted mb-3">POGI NA CEO</p>
                    <p class="small">Pinaka gwapo sa balat n lupa, Masyado nakong malakas para sa mundo ng mga tao. ayaw kol bata pako kol.</p>
                </div>
            </div>
